...
export default function AccountsCasesPage() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Accounts Cases</h1>
        <p className="text-gray-500 mt-1">{total} cases</p>
      </div>
      <DataTable columns={columns} data={cases} page={page} totalPages={totalPages} onPageChange={setPage} loading={loading} emptyMessage="No cases in accounts" />
    </div>
  );
}
